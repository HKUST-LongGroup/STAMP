...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(
        ...
        seg_mask: Optional[torch.Tensor] = None,
            seg_start_id: Optional[int] = None,
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if position_ids is None:
            ...
            if (prefill_compiled_stage or prefill_noncompiled_stage) or self.rope_deltas is None or seg_mask is not None:
        ...
        if seg_mask is not None:
            (
                attention_mask,  # 字典形式的，seg部分是双向mask
                final_position_ids,
            ...
            # print(attention_mask, final_position_ids, '111')
            if past_key_values is not None:
