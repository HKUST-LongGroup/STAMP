...
class QwenVLSFTTrainer:
    ...
    def _create_dummy_dataset(self):
        """
        Create a dataset loaded and shuffled from multiple JSON files.
        In actual use, you need to load data from your data source.
        The dataset format requires a Hugging Face Dataset object containing "image" and "text" columns.
        The "text" column should be a complete dialogue string following the model chat template.
        """
        if IS_MAIN_PROCESS:
        ...
        # file_paths = ['playground/data/filtered_data_under_1024.json']
        # Load all data
        all_data = []
...
if __name__ == '__main__':
    ...
    trainer = QwenVLSFTTrainer(
        ...
        output_dir="output/qwen_vl_seg_sft/gref/",
    )
    trainer.train()